package net.atos.collaborateur.entity;
...
import net.atos.collaborateur.entity.enums.RoleCollaborateur;
import net.atos.collaborateur.entity.enums.TypeCollaborateur;
...
@NoArgsConstructor
@Builder
@Entity(name = "CollaborateurCollaborateurService")
